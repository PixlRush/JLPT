\section[拗音]{\ruby{拗}{よう}\ruby{音}{おん}}\label{sec:PR;仮名;拗音}
...
\input{Primitive/kana/resources/DakutenHiraganaYouon}

\input{Primitive/kana/resources/DakutenKatakanaYouon}
