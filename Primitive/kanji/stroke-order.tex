...
\begin{figure}[H]\label{fig:PR;漢字;書き順;上から下左から右}
	\centering
	\includesvg{Primitive/kanji/resources/svgs/stroke-order/三}
	\hspace{0.5in}
	\includesvg{Primitive/kanji/resources/svgs/stroke-order/川}
\end{figure}
...
\begin{figure}[H]\label{fig:PR;漢字;書き順;横の後に縦}
	\centering
	\includesvg{Primitive/kanji/resources/svgs/stroke-order/十}
\end{figure}
...
\begin{figure}[H]\label{fig:PR;漢字;書き順;刺す画は最後}
	\centering
	\includesvg{Primitive/kanji/resources/svgs/stroke-order/中}
	\hspace{0.5in}
	\includesvg{Primitive/kanji/resources/svgs/stroke-order/母}
\end{figure}
...
\begin{figure}[H]\label{fig:PR;漢字;書き順;対角線は右上が左上より前}
	\centering
	\includesvg{Primitive/kanji/resources/svgs/stroke-order/人}
	\hspace{0.5in}
	\includesvg{Primitive/kanji/resources/svgs/stroke-order/文}
\end{figure}
...
\begin{figure}[H]\label{fig:PR;漢字;書き順;中心の縦線は右左の翼より前に書く}
	\centering
	\includesvg{Primitive/kanji/resources/svgs/stroke-order/水}
	\hspace{0.5in}
	\includesvg{Primitive/kanji/resources/svgs/stroke-order/金}
\end{figure}
...
\begin{figure}[H]\label{fig:PR;漢字;書き順;左の縦線は右か下線の前;口}
	\centering
	\includesvg{Primitive/kanji/resources/svgs/stroke-order/口}
	\hspace{0.5in}
	\includesvg{Primitive/kanji/resources/svgs/stroke-order/口強調}
\end{figure}
...
\begin{figure}[H]\label{fig:PR;漢字;書き順;左の縦線は右か下線の前}
	\centering
	\includesvg{Primitive/kanji/resources/svgs/stroke-order/門}
	\hspace{0.5in}
	\includesvg{Primitive/kanji/resources/svgs/stroke-order/長}
\end{figure}
...
\begin{figure}[H]\label{fig:PR;漢字;書き順;囲む線は囲まれる線より前}
	\centering
	\includesvg{Primitive/kanji/resources/svgs/stroke-order/間}
	\hspace{0.5in}
	\includesvg{Primitive/kanji/resources/svgs/stroke-order/国}
\end{figure}
...
\begin{figure}[H]\label{fig:PR;漢字;書き順;にょうがある最後}
	\centering
	\includesvg{Primitive/kanji/resources/svgs/stroke-order/近}
	\hspace{0.5in}
	\includesvg{Primitive/kanji/resources/svgs/stroke-order/建}
\end{figure}
...
\begin{figure}[H]\label{fig:PR;漢字;書き順;点は最後}
	\centering
	\includesvg{Primitive/kanji/resources/svgs/stroke-order/玉}
	\hspace{0.5in}
	\includesvg{Primitive/kanji/resources/svgs/stroke-order/犬}
\end{figure}
