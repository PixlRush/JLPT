...
\input{Primitives/kana/resources/NoDakutenHiraganaGojyuuon}
...
\footnotetext{Yes that kana 「は」 is read as `wa' here, its a grammatical thing covered on page \pageref{subsec:文法は}}

\input{Primitives/kana/resources/NoDakutenKatakanaGojyuuon}
