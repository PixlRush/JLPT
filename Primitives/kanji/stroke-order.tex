...
\begin{figure}[H]\label{fig:PR;漢字;書き順;上から下左から右}
	\centering
	\includesvg{Primitives/kanji/resources/svgs/三}
	\hspace{0.5in}
	\includesvg{Primitives/kanji/resources/svgs/川}
\end{figure}
...
\begin{figure}[H]\label{fig:PR;漢字;書き順;横の後に縦}
	\centering
	\includesvg{Primitives/kanji/resources/svgs/十}
\end{figure}
...
\begin{figure}[H]\label{fig:PR;漢字;書き順;刺す画は最後}
	\centering
	\includesvg{Primitives/kanji/resources/svgs/中}
	\hspace{0.5in}
	\includesvg{Primitives/kanji/resources/svgs/母}
\end{figure}
...
\begin{figure}[H]\label{fig:PR;漢字;書き順;対角線は右上が左上より前}
	\centering
	\includesvg{Primitives/kanji/resources/svgs/人}
	\hspace{0.5in}
	\includesvg{Primitives/kanji/resources/svgs/文}
\end{figure}
...
\begin{figure}[H]\label{fig:PR;漢字;書き順;中心の縦線は右左の翼より前に書く}
	\centering
	\includesvg{Primitives/kanji/resources/svgs/水}
	\hspace{0.5in}
	\includesvg{Primitives/kanji/resources/svgs/金}
\end{figure}
...
\begin{figure}[H]\label{fig:PR;漢字;書き順;左の縦線は右か下線の前;口}
	\centering
	\includesvg{Primitives/kanji/resources/svgs/口}
	\hspace{0.5in}
	\includesvg{Primitives/kanji/resources/svgs/口強調}
\end{figure}
...
\begin{figure}[H]\label{fig:PR;漢字;書き順;左の縦線は右か下線の前}
	\centering
	\includesvg{Primitives/kanji/resources/svgs/門}
	\hspace{0.5in}
	\includesvg{Primitives/kanji/resources/svgs/長}
\end{figure}
...
\begin{figure}[H]\label{fig:PR;漢字;書き順;囲む線は囲まれる線より前}
	\centering
	\includesvg{Primitives/kanji/resources/svgs/間}
	\hspace{0.5in}
	\includesvg{Primitives/kanji/resources/svgs/国}
\end{figure}
...
\begin{figure}[H]\label{fig:PR;漢字;書き順;にょうがある最後}
	\centering
	\includesvg{Primitives/kanji/resources/svgs/近}
	\hspace{0.5in}
	\includesvg{Primitives/kanji/resources/svgs/建}
\end{figure}
...
\begin{figure}[H]\label{fig:PR;漢字;書き順;点は最後}
	\centering
	\includesvg{Primitives/kanji/resources/svgs/玉}
	\hspace{0.5in}
	\includesvg{Primitives/kanji/resources/svgs/犬}
\end{figure}
